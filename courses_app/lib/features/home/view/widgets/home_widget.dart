...
import 'package:courses_app/features/home/controller/home_controller.dart';
...
class UserName extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: text24Normal(
          text:
              '${Global.storageService.getUserProfile().first_name!} ${Global.storageService.getUserProfile().last_name}',
